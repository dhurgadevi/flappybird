...
const bird = {
    ...
    draw : function(){
        ...
        ctx.drawImage(sprite, bird.sX, bird.sY, this.w, this.h,- this.w/2, - this.h/2, this.w+12, this.h+12);
...
const getReady = {
    ...
    draw: function(){
        if(state.current == state.getReady){
            ctx.drawImage(sprite, this.sX, this.sY, this.w, this.h, this.x-20, this.y+30, this.w+50, this.h+50);
        }
    }
...
const score= {
    ...
    draw : function(){
        ...
        if(state.current == state.game){
            ...
            // SCORE VALUE
            ctx.font = "25px Teko";
            ctx.fillText(this.value, 655, 186);
            ctx.strokeText(this.value, 655, 186);
            // BEST SCORE
            ctx.fillText(this.best, 650, 228);
            ctx.strokeText(this.best, 650, 228);
        }
    },
